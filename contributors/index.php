    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center header-content">
                ...
                <p class="mb-5 term-desc" data-aos="fade-up">Thanks to these folks we've been able to expand our work.
    ...
    <div class="container">
        <div class="row h-100">
                ...
                <div class="col-lg-4 mb-4 review-col" data-aos="fade-up">
                    <div class="review">
                        <div class="d-flex gap-3 align-items-center">
                            <img width="25" height="25" alt="Contributor profile picture"
                                 src="<?= $contributor['picture']; ?>">
                            <p class="review-user"><?= $contributor['name']; ?></p>
                        </div>
            ...
            <div class="col-12 mb-4 text-center mt-5" data-aos="fade-up">
                <a class="primary-button" href="<?= $discord_link ?>">View More</a>
            </div>
        </div>
    </div>
</main>
